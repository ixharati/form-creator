...
export const BuilderCanvas: React.FC<BuilderCanvasProps> = ({
  ...
  return (
    <div
      className="h-full w-full overflow-hidden flex flex-col bg-bg-base"
        ...
        >
          {fields.length === 0 ? (
            ...
            <div className="flex flex-col gap-2 w-full">
              ...
              {/* Drop hint at bottom */}
              <div className="border border-dashed border-border-default rounded-[10px] p-3 text-center text-text-muted text-[11px] mt-1 flex-shrink-0">
